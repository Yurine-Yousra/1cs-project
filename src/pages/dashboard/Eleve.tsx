            ...
            <div className="mt-10 px-10 flex justify-between">
                <SearchBar />
                    ...
                    <div className="relative w-48">
                        ...
                        <button
                            className="flex items-center gap-2 bg-yousra text-white px-4 py-2 rounded-md shadow-lg hover:shadow-2xl hover:cursor-pointer hover:scale-105 transition-all duration-200"
